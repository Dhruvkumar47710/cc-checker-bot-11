...
api_id = '26300562' # Keep this as it is 
api_hash = 'a98fe2051064983aad5520b84bc10004' # same heree
client_token = 'AAEZJVu2fkRyb2VVI5_qp9GK1ogwVaoexGM'

#coded by @Dhruv4771 

admin_ids = [6764559190] # admin IDs
LOG_GROUP_ID = -1002126078187
vip [6764559190]
        ...
        if '.' in rw:
            ...
            if not website_url.startswith(("http://", "https://")):
                ...
                if "Error" in payment_gateways:
                    ...
                    await edit.edit(f""" ┏━━━━━━━⍟\n┃ 𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻 𝗳𝗲𝘁𝗰𝗵𝗲𝗱 ✅\n┗━━━━━━━━━━━━⊛\n 𝗦𝗶𝘁𝗲 -» `{domain}`\n• 𝗚𝗮𝘁𝗲𝘄𝗮𝘆𝘀 ➜ unknown\n━━━━━━━━━━━━━━━\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐓𝐢𝐦𝐞 𝐓𝐚𝐤𝐞𝐧 : `{rounded_time_taken}``s`\n[◈](https://i.ibb.co/CMcdMjf/Blue-Tosca-Geometric-Technology-Linkedln-Banner.png) 𝐁𝐨𝐭 [𝗚𝗮𝘁𝗲𝘄𝗮𝘆 𝗟𝗼𝗼𝗸𝘂𝗽V2](https://t.me/Dhruvccbot)\n❝ ━━━━・{ch}・━━━━ ❞""")
                else:
                    ...
                    if event.sender.id in pre:
                        ...
                        ch_name = '『Dhruv』』'
                        ch_id = 'Dack_world'
                        ch = f"[{ch_name}](https://t.me/Dhruv4771)"
                        end_time = time.time()
                        time_taken = end_time - start_time
                        rounded_time_taken = round(time_taken, 2)
                        user_id = event.sender_id
